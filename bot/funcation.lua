...
local function channel_get_admins(channel,cb)
  local function callback_admins(extra,result,success)
    ...
    cernerbot.getChannelMembers(channel, 0, 'Administrators', limit,cb)
     else return cernerbot.sendText(channel,0, 1,'ابتدا ربات را ادمین کنید', 'html') end
    end
  cernerbot.getChannelFull(channel,callback_admins)
end
...
local function callback_admins(extra,result,success)
    ...
    cernerbot.getChannelMembers(channel, 0, 'Bots', limit,cb)
    end
  cernerbot.getChannelFull(channel,callback_admins)
end
...
local function callback_admins(extra,result,success)
    ...
    cernerbot.getChannelMembers(channel, 0, 'Kicked', limit,cb)
    end
  cernerbot.getChannelFull(channel,callback_admins)
end
